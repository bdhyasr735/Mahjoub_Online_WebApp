...
CORS(app, resources={r"/admin/*": {"origins": ["[https://studio.apollographql.com](https://studio.apollographql.com)", "http://localhost:5000"]}}, supports_credentials=True)
...
def load_user(user_id):
    ...
    if user_type == 'admin': 
        ...
        # إذا كان موظف إداري (AdminStaff) أو موظف مورد
    ...
    # محاولة البحث العام المتسلسل إذا لم يتم تحديد user_type بدقة
    return (
...
talisman.init_app(app, 
    content_security_policy={
        'default-src': ["'self'"],
        'style-src': ["'self'", "'unsafe-inline'", "[https://fonts.googleapis.com](https://fonts.googleapis.com)", "[https://cdn.jsdelivr.net](https://cdn.jsdelivr.net)", "[https://cdnjs.cloudflare.com](https://cdnjs.cloudflare.com)", "[https://ckeditor.com](https://ckeditor.com)"],
        'font-src': ["'self'", "[https://fonts.gstatic.com](https://fonts.gstatic.com)", "[https://cdn.jsdelivr.net](https://cdn.jsdelivr.net)", "[https://cdnjs.cloudflare.com](https://cdnjs.cloudflare.com)"],
        'script-src': ["'self'", "'unsafe-inline'", "'unsafe-eval'", "[https://code.jquery.com](https://code.jquery.com)", "[https://cdn.jsdelivr.net](https://cdn.jsdelivr.net)", "[https://cdnjs.cloudflare.com](https://cdnjs.cloudflare.com)", "[https://ckeditor.com](https://ckeditor.com)"],
        'img-src': ["'self'", "data:", "https://*"],
        'connect-src': ["'self'", "[https://ckeditor.com](https://ckeditor.com)", "https://*.ckeditor.com"]
    },
