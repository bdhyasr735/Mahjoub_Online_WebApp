...
from flask_limiter import Limiter              # 1. إضافة الاستيراد
from flask_limiter.util import get_remote_address # 2. إضافة دالة تحديد عنوان IP
