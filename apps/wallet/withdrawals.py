# coding: utf-8
# 📂 apps/wallet/withdrawals.py - إدارة طلبات السحب
...
# ✅ افترض أن الاسم هكذا، إذا لم يكن موجوداً أعدله
try:
...
# 💡 سنستخدم البلوبريت نفسه (wallet_bp) لكن عن طريق استيراده من routes
