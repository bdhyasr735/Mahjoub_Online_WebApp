...
def save_sync_supplier_product():
    ...
    try:
        ...
        # تحديث باستخدام raw_qid_for_api
        try:
...
def sync_batch_products():
    try:
        ...
        # استخراج معلومات المستخدم من current_user أولاً
        ...
        if is_admin:
            ...
            for product in products_list:
                ...
                if mapping:
                    ...
                    # لا ننشئ روابط جديدة تلقائياً (يمكن تفعيلها إذا أردت)
                    pass
