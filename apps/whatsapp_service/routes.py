...
# تعريف الـ Blueprint الإداري (متوافق مع الهيكلة العامة /dashboard/admin/whatsapp)
whatsapp_bp = Blueprint(
    'whatsapp_service', 
    __name__, 
    template_folder='templates',
    url_prefix='/dashboard/admin/whatsapp'
)

# تعريف Blueprint عام لمسارات الويب هوك المباشرة بدون بادئة
