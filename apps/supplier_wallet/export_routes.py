...
@supplier_wallet_bp.route('/wallet/export-pdf', methods=['GET'], strict_slashes=False, endpoint='supplier_wallet_export_statement')
@supplier_wallet_bp.route('/withdraw/export-pdf', methods=['GET'], strict_slashes=False, endpoint='supplier_wallet_export_statement_withdraw')
@login_required
